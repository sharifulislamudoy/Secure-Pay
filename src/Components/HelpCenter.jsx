        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover:bg-blue-50">
            ...
            <ul className="text-gray-600 space-y-3">
              <li>
                <a href="/create-account" className="text-blue-500 hover:text-blue-700">
                  How to create an account?
                </a>
              </li>
              <li>
                <a href="/reset-password" className="text-blue-500 hover:text-blue-700">
                  Password reset instructions
                </a>
              </li>
              <li>
                <a href="/account-verification" className="text-blue-500 hover:text-blue-700">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover:bg-blue-50">
            ...
            <ul className="text-gray-600 space-y-3">
              <li>
                <a href="/payment-method" className="text-blue-500 hover:text-blue-700">
                  How to make a payment?
                </a>
              </li>
              <li>
                <a href="/refund-policy" className="text-blue-500 hover:text-blue-700">
                  Refund policy
                </a>
              </li>
              <li>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover:bg-blue-50">
            ...
            <ul className="text-gray-600 space-y-3">
              <li>
                <a href="/data-security" className="text-blue-500 hover:text-blue-700">
                  How secure is my data?
                </a>
              </li>
              <li>
                <a href="/two-factor-authentication" className="text-blue-500 hover:text-blue-700">
                  Two-factor authentication setup
                </a>
              </li>
              <li>
                <a href="/report" className="text-blue-500 hover:text-blue-700">
